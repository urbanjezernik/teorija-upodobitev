...
\todo[inline]{(Schurs Lemma, version II).}

\todo[inline]{Zgled: Corollary 2.7.17 (Abelian groups and central character).}
...
- dokažemo Clebsch-Gordan
- pokažemo povezavo z $sl_2$ (lahko eksplicitno opišemo vse nerazcepne, pokažemo kako so bijektivno (!) povezane z racionalnimi (algebraičnimi) upodobitvami $SL_2$)
- zvezne upodobitve $SL_2$: te plus konjugiranke (samo rezultat)
- abstraktne upodobitve ???
}
