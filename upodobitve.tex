...
\item Fourierova transformacija funkcije $1_{2A}$ v $\chi$ je enaka
\[
...
\]
Izoliramo prispevek trivialne upodobitve. Pri $j = 0$ dobimo $\widehat{1_A}(\chi_0) = \widehat{1_A}(\11) = |A|$, zato je zadnja vsota enaka
\[
