...
Tekom dokaza smo premislili, da je $\youngsym * \youngsym = n_{\lambda} \cdot \youngsym$ za nek $n_{\lambda} \neq 0$. Od tod sledi, da je $V_{\lambda}$ slika \emph{projektorske} spletične $\Fcal(\youngsym / n_{\lambda})$. Youngov simetrizator nam torej prek Fourierove transformacije izdaja nerazcepno upodobitev $V_{\lambda}$.
