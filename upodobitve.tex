...
\todo{Izračunaj $\chi_{\lambda}(1)$.}

Iz izreka neposredno sledi, da so vrednosti karakterjev zelo posebne.\footnote{To posledico bi sicer lahko izpeljali tudi brez zahtevne Frobeniusove formule, glej na primer {\literatura (Serre 1977, [Section 13.1, Corollary 1])}.}
