...
\begin{domacanaloga}
Preveri, da je $\EE_G(\rho) \in \hom_G(V,V)$ projekcijska spletična na podprostor fiksnih vektorjev $V^G$. 
\end{domacanaloga}
...
\begin{trditev}
Naj bo $G$ končna grupa z nerazcepno upodobitvijo $\pi$ nad algebraično zaprtim poljem karakteristike tuje $|G|$. Tedaj za vse $i,j,k,l$ velja
\[
