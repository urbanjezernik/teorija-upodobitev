...
\[
    \gamma(\chi_1, \chi_2) = \Ind^{G_p}_{B_p}(\rho(\chi_1, \chi_2))
\] 
...
\begin{domacanaloga}
Izračunaj vrednosti karakterjev upodobitve $\gamma(\chi_1, \chi_2)$.
\end{domacanaloga}
...
\begin{tabular}{l|*{4}{c}}
    ...
    $\begin{pmatrix}
        a & \epsilon b \\ b & a
    \end{pmatrix}$ \\ \hline
    $\gamma(\chi_1, \chi_2)$ & $(p+1) \chi_1(a) \chi_2(a)$ & $\chi_1(a) \chi_2(a)$ & $\chi_1(a) \chi_2(b) + \chi_2(a) \chi_1(b)$ & $0$ \\
\end{tabular}
\caption{Karakter upodobitve $\gamma(\chi_1, \chi_2)$ grupe $G_p$}
\end{table}

Od tod po preprostem računu določimo normo karakterja kot
\[
    || \chi_{\gamma(\chi_1, \chi_2)} ||^2 = 
    \begin{cases}
        2 & \chi_1 = \chi_2, \\
        1 & \chi_1 \neq \chi_2.
    \end{cases}
\]
Za $\chi_1 \neq \chi_2$ je upodobitev $\gamma(\chi_1, \chi_2)$ torej nerazcepna. Iz karakterja opazimo, da je $\rho$ simetrična v svojih argumentih, se pravi $\gamma(\chi_1, \chi_2) \cong \gamma(\chi_2, \chi_1)$. Na ta način torej dobimo $\binom{p-1}{2} = (p-1)(p-2)/2$ nerazcepnih upodobitev grupe $G_p$. Tem upodobitvam pravimo {\definicija upodobitve glavne vrste}. V primeru, ko je $\chi_1 = \chi_2$, iz vrednosti karakterjev opazimo izomorfizem $\gamma(\chi, \chi) \cong \St(\chi) \oplus (\chi \circ \det)$, torej tukaj ne najdemo nobenih novih nerazcepnih upodobitev.
