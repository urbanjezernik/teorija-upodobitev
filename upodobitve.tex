...
\todo{$SU_2$ zgled nerazcepnih upodobitev? Ne, za to moramo najprej razumeti izotipične komponente. Mogoče lahko tukaj samo povemo za te upodobitve in napovemo, da bomo to dokazali s pomočjo razvite teorije.}
...
\todo{Tole lahko delno združimo s Schurovo lemo, delno pa dodamo v polenostavnost.}
...
- primer nerazcepnih upodobitev $SU_2$, mogoče tudi Clebsch-Gordan koeficienti?
