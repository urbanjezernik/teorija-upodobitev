...
\item {\literatura S. Peluse, {\em Recent progress on bounds for sets with no three terms in arithmetic progression}, Séminaire BOURBAKI, 74e année, 2021-2022, no 1196.}
\end{itemize}
...
\subsection{Glavni del in prispevki netrivialnih karakterjev}
...
\todo[inline]{Gowers kot nekomutativna posplošitev (omeni uporabo v Babai conjecture, Helfgott), dokaz kot Eberhard}
