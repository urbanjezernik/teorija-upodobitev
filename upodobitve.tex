...
\]
Tej enakosti rečemo {\definicija Parsevalova formula}.
...
\todo{Fourier diagonalizira matriko sosednosti (Diaconis, str. 48).}

\subsection{Komutatorji}

\todo[inline]{??? čisto nekomutativen problem: komutatorji; Frobeniusova formula, omeni LOST Ore domneva}
