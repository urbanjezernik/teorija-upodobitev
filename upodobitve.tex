...
\]
Ker je $f$ razredna funkcija, je dobljeno ravno enako $\pi(h) \cdot \EE_f(\pi)$. Uteženo povprečje je torej v tem primeru spletična v $\hom_G(\pi, \pi)$. Po Schurovi lemi sklepamo, da je $\EE_f(\pi)$ skalarni večkratnik identitete s sledjo
\[
