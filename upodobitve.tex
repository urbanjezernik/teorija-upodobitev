...
\end{zgled}
    ...
    \todo{Tu gre bolj za to, da ko imamo enkrat tabelo karakterjev, lahko vsako upodobitev tudi eksplicitno rastavimo na nerazcepne.}
...
\todo[inline]{
    tu je vse nad $\CC$
    - dekompozicija razrednih funkcij (to je že od prej)
    - druga ortogonalnost
