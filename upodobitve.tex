...
\begin{posledica}
Naj bo $G$ grupa z nerazcepno upodobitvijo $\pi$ končne razsežnosti nad \emph{algebraično zaprtim poljem}. Tedaj množica $\hom_G(\pi, \pi)$ sestoji le iz skalarnih večkratnikov identitete.
\end{posledica}
\begin{dokaz}
