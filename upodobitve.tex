...
\subsubsection{Tabela karakterjev, 1. del}
...
\subsubsection{Tabela karakterjev, 2. del}
...
\subsubsection{Onkraj $\GL_2(\FF_p)$}
...
\[
    \GL_{m_1}(\FF_q) \times \GL_{m_2}(\FF_q) \times \cdots \times \GL_{m_k}(\FF_q).  
\]
