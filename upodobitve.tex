...
\subsubsection{Matrike višjih razsežnosti}
...
\todo[inline]{Gowers: Roth kot primer za abelove grupe (omeni Bloom etc sodobne rezultate)}


\todo{Omeni, da smo zvezo s konvolucijo videli že pri spletičnah (vse so iz Fourieranja) in pri simetirčnih grupah.}
