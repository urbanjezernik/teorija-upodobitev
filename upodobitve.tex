...
\]
Izolirajmo prispevek trivialne upodobitve. Velja $\widehat{1_A}(\chi_0) = \widehat{1_A}(\11) = |A|$, zato je zadnja vsota enaka
\[
...
Če izberemo $x,y,z \in \FF_p$ enakomerno naključno, a pogojno na veljavnost $x+y=2z$,\footnote{Na ta način torej izbiramo aritmetična zaporedja v $\FF_p$ dolžine $3$.} potem je po izračunu v zadnjem razdelku verjetnost, da so $x,y,z$ vsi v $A$, enaka
\[
    \PP_{x,y,z \in \FF_p}(x,y,z \in A \mid x+y=2z) =
    \delta^3 + \frac{1}{p^3} \sum_{j \in \FF_p^*} \widehat{1_A(\chi_j)}^2 \widehat{1_A}(\chi_{-2j}).
\]
Brez pogojne omejitve bi bila zgornja verjetnost seveda enaka $\delta^3$. Srčica pogoja aritmetičnega zaporedja dolžine $3$ se torej skriva v prispevkih netrivialnih karakterjev. Naš cilj je dokazati, da ti prispevki nikdar ne uspejo izničiti glavnega delta $\delta^3$ in da v $A$ torej res obstaja aritmetično zaporedje dolžine $3$. 
