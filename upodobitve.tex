...
\subsection{Koeficienti in regularna upodobitev}

Matrične koeficiente lahko vidimo kot elemente vektorskega prostora funkcij $\hom(G,F)$ iz $G$ v $F$.

\todo[inline]{
    - tvorijo podupodobitev regularne
    - to podupodobitev prepoznamo z adjunkcijo in izotipično komponento
    - posledica: koeficienti so neodvisni
...
Na podlagi \emph{linearnih} lastnosti teh matričnih koeficientov lahko prepoznamo nerazcepne upodobitve.

\begin{posledica}[Burnsideov izrek o nerazcepnosti]
