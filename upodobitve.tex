...
Iz izreka sledi, da lahko za vsako upodobitev $\rho$ grupe $G$ na končno razsežnem prostoru najdemo bazo prostora, v kateri imajo vse matrike $\rho(g)$ za $g \in G$ \emph{bločnozgornjetrikotno} obliko. Po drugi strani je upodobitev polenostavna, kadar lahko najdemo bazo prostora, v kateri imajo vse matrike \emph{bločno} obliko.
...
\]
Po Schurovi lemi je vsak od zadnjih prostorov spletičen bodisi trivialen bodisi enorazsežen. Večkratnost $\pi$ v $\rho$ lahko zatorej izračunamo kot
\[
...
\item \todo{Kako izgleda $\Izotip_{\pi}(\rho)$, če je $\pi$ enodim?Example 2.7.10}
\end{itemize}
\end{zgled}
