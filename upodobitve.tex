...
\begin{zgled}
Naj bo $G$ končna grupa z upodobitvijo $\rho$ na prostoru $V$ nad algebraično zaprtim poljem karakteristike tuje $|G|$. Ni težko preveriti, da je linearna preslikava
\[
    \frac{1}{|G|} \sum_{g \in G} \rho(g)
\]
projekcijska spletična v $\hom_G(V,V)$ na $\11$-izotipično komponento v $V$, se pravi na podprostor fiksnih vektorjev $V^G$.
\end{zgled}
