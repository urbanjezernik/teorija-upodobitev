...
\]
Kadar je $F = \CC$, uteženemu povprečenju rečemo tudi {\definicija nekomutativna Fourierova transformacija}. Njeno povezavo s klasično teorijo Fourierove transformacije bomo spoznali nekoliko kasneje.
