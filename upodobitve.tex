...
\end{tabular}
\caption{Karakter upodobitve $\Ind_{T_{nr}}^{G_p}$ grupe $G_p$}
\end{table}
...
\[
    \chi \colon S_p \to \CC^*, \quad
    \psi \colon U_p \to \CC^*
\]
in tvorimo produktno upodobitev $\chi \times \psi$ grupe $C_p$. To upodobitev induciramo na grupo $G_p$. S formulo za izračun karakterjev inducirane upodobitve ni težko določiti njenega karakterja.
