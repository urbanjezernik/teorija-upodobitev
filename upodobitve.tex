...
Sodobna bilijardna domneva {\literatura \href{https://arxiv.org/pdf/1703.05898.pdf}{(Lusztig-Williamson 2018)}} predvideva, da se te večkratnosti obnašajo po zakonu nekega zakompliciranega dinamičnega sistema (\href{https://www.youtube.com/watch?v=Ru0Zys1Vvq4}{video}).
...
\[
    ...
    1,
\]
kot mora biti, saj že vemo, da je v tem primeru $V_{\lambda} \cong \11$. Dolžine kljuk so $|H_{\lambda}(i,1)| = n-i$, zato formula o kljukah za ta trivialen primer drži. Splošnega primera ni težko izpeljati z indukcijo.
