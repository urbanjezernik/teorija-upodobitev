...
Implementacija predstavljenega algoritma za izračun tabele karakterjev v programskem jeziku \GAP~je dostopna \href{https://github.com/urbanjezernik/teorija-upodobitev/blob/main/racunanje-tabele.g}{tukaj}.

\todo{Omeni boljši algoritem, ki ga uporablja GAP: 1. hitrejši, ker so matrike manjše. 2. nad končnim poljem, zato so računi eksaktni.}
